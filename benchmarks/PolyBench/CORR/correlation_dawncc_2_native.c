...
// Determine mean of column vectors of input data matrix
  ...
  //data 2050 4196351
  //mean 1 2048
  RST_AI1 |= !(((void*) (data + 0) > (void*) (mean + 2048))
  || ((void*) (mean + 0) > (void*) (data + 4198400)));
...
// Calculate the m * m correlation matrix.
  ...
  //data 2050 4196350
  //symmat 2050 4196351
  RST_AI4 |= !(((void*) (data + 0) > (void*) (symmat + 4198400))
  || ((void*) (symmat + 0) > (void*) (data + 4198400)));
  #pragma omp target data map(to: data[0:4198401]) map(tofrom: symmat[0:4198400]) if(!RST_AI4)
  {
