...
// Determine mean of column vectors of input data matrix
  char RST_AI1 = 0;
  RST_AI1 |= !(((void*) (data + 0) > (void*) (mean + 4096))
  || ((void*) (mean + 1) > (void*) (data + 16785408)));
  #pragma omp target data map(to: data[0:16785409]) map(tofrom: mean[0:4097]) if(!RST_AI1)
  {
...
// Calculate the m * m correlation matrix.
  char RST_AI4 = 0;
  RST_AI4 |= !(((void*) (data + 0) > (void*) (symmat + 16785408))
  || ((void*) (symmat + 0) > (void*) (data + 16785408)));
  #pragma omp target data map(to: data[0:16785409]) map(tofrom: symmat[0:16785409]) if(!RST_AI4)
  {
