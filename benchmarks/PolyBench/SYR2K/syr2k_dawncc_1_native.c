...
void GPU__syr2k(DATA_TYPE *A, DATA_TYPE *B, DATA_TYPE *C) {
    ...
    char RST_AI1 = 0;
    RST_AI1 |= !(((void *)(A + 0) > (void *)(B + 16777215)) || ((void *)(B + 0) > (void *)(A + 16777215)));
    RST_AI1 |= !(((void *)(A + 0) > (void *)(C + 16777215)) || ((void *)(C + 0) > (void *)(A + 16777215)));
    RST_AI1 |= !(((void *)(B + 0) > (void *)(C + 16777215)) || ((void *)(C + 0) > (void *)(B + 16777215)));
#pragma omp target data map(to : A [0:16777216], B [0:16777216]) map(tofrom : C [0:16777216]) if (!RST_AI1)
    {
...
int main() {
    ...
    if (threshold > N * M * sizeof(DATA_TYPE)) {
