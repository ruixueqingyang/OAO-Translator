...
/* Determine mean of column vectors of input data matrix */
  ...
  char RST_AI1 = 0;
  RST_AI1 |= !(((void*) (data + 0) > (void*) (mean + 1023))
  || ((void*) (mean + 0) > (void*) (data + 1050624)));
  RST_AI1 |= !(((void*) (data + 0) > (void*) (symmat + 1050624))
  || ((void*) (symmat + 0) > (void*) (data + 1050624)));
  RST_AI1 |= !(((void*) (mean + 0) > (void*) (symmat + 1050624))
  || ((void*) (symmat + 0) > (void*) (mean + 1023)));
  #pragma omp target data map(tofrom: data[0:1050625],mean[0:1024],symmat[0:1050625]) if(!RST_AI1)
  {
