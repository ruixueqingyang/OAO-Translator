...
/* Determine mean of column vectors of input data matrix */
  ...
  RST_AI1 |= !(((void*) (data + 0) > (void*) (symmat + 4198400))
  || ((void*) (symmat + 0) > (void*) (data + 4198400)));
  RST_AI1 |= !(((void*) (mean + 0) > (void*) (symmat + 4198400))
  || ((void*) (symmat + 0) > (void*) (mean + 2048)));
  #pragma omp target data map(tofrom: data[0:4198401],mean[0:2049],symmat[0:4198401]) if(!RST_AI1)
  {
