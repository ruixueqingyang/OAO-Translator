...
void GPU__gemm(DATA_TYPE *A, DATA_TYPE *B, DATA_TYPE *C) {
  ...
  s1 = rtclock();
  #pragma omp target enter data map(to: A[0:4194304],B[0:4194304],C[0:4194304]) if(!RST_AI1)
  e1 = rtclock();
  {
