...
void GPU__bicg(DATA_TYPE *A, DATA_TYPE *r, DATA_TYPE *s, DATA_TYPE *p,
  ...
  {
    char RST_AI2 = 0;
    RST_AI2 |= !(((void*) (A + 0) > (void*) (r + 32768))
    || ((void*) (r + 0) > (void*) (A + 1073741824)));
    RST_AI2 |= !(((void*) (A + 0) > (void*) (s + 32768))
    || ((void*) (s + 0) > (void*) (A + 1073741824)));
    RST_AI2 |= !(((void*) (r + 0) > (void*) (s + 32768))
    || ((void*) (s + 0) > (void*) (r + 32768)));
    #pragma omp target data map(to: A[0:1073741824],r[0:32768]) map(tofrom: s[0:32768]) if(!RST_AI2)
    {
    #pragma omp target teams distribute parallel for if(!RST_AI2)
    for (j = 0; j < NY; j++) {
      for (i = 0; i < NX; i++) {
        s[j] = s[j] + r[i] * A[i * NY + j];
      }
    ...
    char RST_AI3 = 0;
    RST_AI3 |= !(((void*) (A + 0) > (void*) (p + 32768))
    || ((void*) (p + 0) > (void*) (A + 1073741824)));
    RST_AI3 |= !(((void*) (A + 0) > (void*) (q + 32768))
    || ((void*) (q + 0) > (void*) (A + 1073741824)));
    RST_AI3 |= !(((void*) (p + 0) > (void*) (q + 32768))
    || ((void*) (q + 0) > (void*) (p + 32768)));
    #pragma omp target data map(to: A[0:1073741824],p[0:32768]) map(tofrom: q[0:32768]) if(!RST_AI3)
    {
    #pragma omp target teams distribute parallel for if(!RST_AI3)
    for (i = 0; i < NX; i++) {
      q[i] = 0.0;
      for (j = 0; j < NY; j++) {
        q[i] = q[i] + A[i * NY + j] * p[j];
