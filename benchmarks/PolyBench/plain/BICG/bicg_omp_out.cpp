...
void GPU__bicg(DATA_TYPE* A, DATA_TYPE* r, DATA_TYPE* s, DATA_TYPE* p, DATA_TYPE* q)
{
  ...
  OAODataTrans( s, StConstrTarget.init(7, 3) );
  for (i = 0; i < NY; i++)
    {
      s[i] = 0.0;
    }
...
int main()
{
  ...
  OAODataTrans( r, StConstrTarget.init(7, 3) );
  OAODataTrans( p, StConstrTarget.init(7, 3) );
  init_array(A, p, r);
  ...
  OAODataTrans( s_GPU, StConstrTarget.init(7, 3) );
  OAODataTrans( q_GPU, StConstrTarget.init(7, 3) );
  update(s_GPU, q_GPU);
