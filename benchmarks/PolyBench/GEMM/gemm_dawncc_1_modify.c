...
void GPU__gemm(DATA_TYPE *A, DATA_TYPE *B, DATA_TYPE *C) {
  ...
  char RST_AI1 = 0;
  RST_AI1 |= !(((void*) (A + 0) > (void*) (B + 9437184))
  || ((void*) (B + 0) > (void*) (A + 9437184)));
  RST_AI1 |= !(((void*) (A + 0) > (void*) (C + 9437184))
  || ((void*) (C + 0) > (void*) (A + 9437184)));
  RST_AI1 |= !(((void*) (B + 0) > (void*) (C + 9437184))
  || ((void*) (C + 0) > (void*) (B + 9437184)));
  s1 = rtclock();
  #pragma omp target enter data map(to: A[0:9437184],B[0:9437184],C[0:9437184]) if(!RST_AI1)
  e1 = rtclock();
  {
