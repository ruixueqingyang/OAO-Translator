...
cd /home/ghn/work/polybench/plain/GEMM
...
then
   ...
   FILE="/home/ghn/work/polybench/plain/GEMM/result_1.txt"
elif [ $option == $num2 ]
then
   make DEBUG=-D_DEBUG_2 OMP0  #OMP
   make DAWN_2  #DawnCC
   make DEBUG=-D_DEBUG_2 OAO   #OAO
   FILE="/home/ghn/work/polybench/plain/GEMM/result_2.txt"
else
   make DEBUG=-D_DEBUG_ OMP0  #OMP
   make DAWN  #DawnCC
   make DEBUG=-D_DEBUG_ OAO   #OAO
   FILE="/home/ghn/work/polybench/plain/GEMM/result_3.txt"
fi
