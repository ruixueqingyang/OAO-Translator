...
void GPU__gemm(DATA_TYPE *A, DATA_TYPE *B, DATA_TYPE *C) {
  ...
  char RST_AI1 = 0;
  RST_AI1 |= !(((void*) (A + 0) > (void*) (B + 4194303))
  || ((void*) (B + 0) > (void*) (A + 4194303)));
  RST_AI1 |= !(((void*) (A + 0) > (void*) (C + 4194303))
  || ((void*) (C + 0) > (void*) (A + 4194303)));
  RST_AI1 |= !(((void*) (B + 0) > (void*) (C + 4194303))
  || ((void*) (C + 0) > (void*) (B + 4194303)));
