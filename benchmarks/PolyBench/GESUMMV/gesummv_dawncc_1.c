...
void GPU__gesummv(DATA_TYPE *A, DATA_TYPE *B, DATA_TYPE *x, DATA_TYPE *y,
  ...
  char RST_AI1 = 0;
  RST_AI1 |= !(((void*) (A + 0) > (void*) (B + 1073741823))
  || ((void*) (B + 0) > (void*) (A + 1073741823)));
  RST_AI1 |= !(((void*) (A + 0) > (void*) (tmp + 32767))
  || ((void*) (tmp + 0) > (void*) (A + 1073741823)));
  RST_AI1 |= !(((void*) (A + 0) > (void*) (x + 32767))
  || ((void*) (x + 0) > (void*) (A + 1073741823)));
  RST_AI1 |= !(((void*) (A + 0) > (void*) (y + 32767))
  || ((void*) (y + 0) > (void*) (A + 1073741823)));
  RST_AI1 |= !(((void*) (B + 0) > (void*) (tmp + 32767))
  || ((void*) (tmp + 0) > (void*) (B + 1073741823)));
  RST_AI1 |= !(((void*) (B + 0) > (void*) (x + 32767))
  || ((void*) (x + 0) > (void*) (B + 1073741823)));
  RST_AI1 |= !(((void*) (B + 0) > (void*) (y + 32767))
  || ((void*) (y + 0) > (void*) (B + 1073741823)));
  RST_AI1 |= !(((void*) (tmp + 0) > (void*) (x + 32767))
  || ((void*) (x + 0) > (void*) (tmp + 32767)));
  RST_AI1 |= !(((void*) (tmp + 0) > (void*) (y + 32767))
  || ((void*) (y + 0) > (void*) (tmp + 32767)));
  RST_AI1 |= !(((void*) (x + 0) > (void*) (y + 32767))
  || ((void*) (y + 0) > (void*) (x + 32767)));
  #pragma omp target data map(to: A[0:1073741824],B[0:1073741824],x[0:32768]) map(tofrom: tmp[0:32768],y[0:32768]) if(!RST_AI1)
  {
