...
void GPU__gesummv(DATA_TYPE *A, DATA_TYPE *B, DATA_TYPE *x, DATA_TYPE *y,
  ...
  char RST_AI1 = 0;
  RST_AI1 |= !(((void*) (A + 0) > (void*) (B + 268435456))
  || ((void*) (B + 0) > (void*) (A + 268435456)));
  RST_AI1 |= !(((void*) (A + 0) > (void*) (tmp + 16384))
  || ((void*) (tmp + 0) > (void*) (A + 268435456)));
  RST_AI1 |= !(((void*) (A + 0) > (void*) (x + 16384))
  || ((void*) (x + 0) > (void*) (A + 268435456)));
  RST_AI1 |= !(((void*) (A + 0) > (void*) (y + 16384))
  || ((void*) (y + 0) > (void*) (A + 268435456)));
  RST_AI1 |= !(((void*) (B + 0) > (void*) (tmp + 16384))
  || ((void*) (tmp + 0) > (void*) (B + 268435456)));
  RST_AI1 |= !(((void*) (B + 0) > (void*) (x + 16384))
  || ((void*) (x + 0) > (void*) (B + 268435456)));
  RST_AI1 |= !(((void*) (B + 0) > (void*) (y + 16384))
  || ((void*) (y + 0) > (void*) (B + 268435456)));
  RST_AI1 |= !(((void*) (tmp + 0) > (void*) (x + 16384))
  || ((void*) (x + 0) > (void*) (tmp + 16384)));
  RST_AI1 |= !(((void*) (tmp + 0) > (void*) (y + 16384))
  || ((void*) (y + 0) > (void*) (tmp + 16384)));
  RST_AI1 |= !(((void*) (x + 0) > (void*) (y + 16384))
  || ((void*) (y + 0) > (void*) (x + 16384)));
  s1 = rtclock();
  #pragma omp target enter data map(to: A[0:268435456],B[0:268435456],x[0:16384],tmp[0:16384],y[0:16384]) if(!RST_AI1)
  e1 = rtclock();
  {
