...
void GPU__gesummv(DATA_TYPE *A, DATA_TYPE *B, DATA_TYPE *x, DATA_TYPE *y,
  ...
  s1 = rtclock();
  #pragma omp target enter data map(to: A[0:67108864],B[0:67108864],x[0:8192],tmp[0:8192],y[0:8192]) if(!RST_AI1)
  e1 = rtclock();
  {
  ...
  printf("Host to Device number of byte is: %ld\n", (67108864+67108864+8192+8192+8192) * sizeof(DATA_TYPE));
