...
void GPU__gesummv(DATA_TYPE *A, DATA_TYPE *B, DATA_TYPE *x, DATA_TYPE *y,
  ...
  char RST_AI1 = 0;
  RST_AI1 |= !(((void*) (A + 0) > (void*) (B + 268435455))
  || ((void*) (B + 0) > (void*) (A + 268435455)));
  RST_AI1 |= !(((void*) (A + 0) > (void*) (tmp + 16383))
  || ((void*) (tmp + 0) > (void*) (A + 268435455)));
  RST_AI1 |= !(((void*) (A + 0) > (void*) (x + 16383))
  || ((void*) (x + 0) > (void*) (A + 268435455)));
  RST_AI1 |= !(((void*) (A + 0) > (void*) (y + 16383))
  || ((void*) (y + 0) > (void*) (A + 268435455)));
  RST_AI1 |= !(((void*) (B + 0) > (void*) (tmp + 16383))
  || ((void*) (tmp + 0) > (void*) (B + 268435455)));
  RST_AI1 |= !(((void*) (B + 0) > (void*) (x + 16383))
  || ((void*) (x + 0) > (void*) (B + 268435455)));
  RST_AI1 |= !(((void*) (B + 0) > (void*) (y + 16383))
  || ((void*) (y + 0) > (void*) (B + 268435455)));
  RST_AI1 |= !(((void*) (tmp + 0) > (void*) (x + 16383))
  || ((void*) (x + 0) > (void*) (tmp + 16383)));
  RST_AI1 |= !(((void*) (tmp + 0) > (void*) (y + 16383))
  || ((void*) (y + 0) > (void*) (tmp + 16383)));
  RST_AI1 |= !(((void*) (x + 0) > (void*) (y + 16383))
  || ((void*) (y + 0) > (void*) (x + 16383)));
  #pragma omp target data map(to: A[0:268435456],B[0:268435456],x[0:16384]) map(tofrom: tmp[0:16384],y[0:16384]) if(!RST_AI1)
  {
