...
void runFdtd_OMP(DATA_TYPE *_fict_, DATA_TYPE *ex, DATA_TYPE *ey,
  ...
  char RST_AI1 = 0;
    RST_AI1 |= !(((void*) (_fict_ + 0) > (void*) (ex + 67117055))
    || ((void*) (ex + 0) > (void*) (_fict_ + 1499)));
    RST_AI1 |= !(((void*) (_fict_ + 0) > (void*) (ey + 67117055))
    || ((void*) (ey + 0) > (void*) (_fict_ + 1499)));
    RST_AI1 |= !(((void*) (_fict_ + 0) > (void*) (hz + 67108863))
    || ((void*) (hz + 0) > (void*) (_fict_ + 1499)));
    ...
    #pragma omp target data map(to: _fict_[0:1500]) map(tofrom: ex[0:67117056],ey[0:67117056],hz[0:67108864]) if(!RST_AI1)
    {
  for (t = 0; t < tmax; t++) {
