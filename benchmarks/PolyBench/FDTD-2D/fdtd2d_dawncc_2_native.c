...
void runFdtd_OMP(DATA_TYPE *_fict_, DATA_TYPE *ex, DATA_TYPE *ey,
  ...
  int t, i, j;
    ...
    char RST_AI1 = 0;
    RST_AI1 |= !(((void*) (_fict_ + 0) > (void*) (ex + 16781311))
    || ((void*) (ex + 0) > (void*) (_fict_ + 999)));
    RST_AI1 |= !(((void*) (_fict_ + 0) > (void*) (ey + 16781311))
    || ((void*) (ey + 0) > (void*) (_fict_ + 999)));
    RST_AI1 |= !(((void*) (_fict_ + 0) > (void*) (hz + 16777215))
    || ((void*) (hz + 0) > (void*) (_fict_ + 999)));
    ...
    #pragma omp target data map(to: _fict_[0:1000]) map(tofrom: ex[0:16781312],ey[0:16781312],hz[0:16777216]) if(!RST_AI1)
    {
  for (t = 0; t < tmax; t++) {
