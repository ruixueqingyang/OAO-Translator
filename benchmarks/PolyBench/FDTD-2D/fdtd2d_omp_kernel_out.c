...
#pragma omp target teams distribute parallel for private(j)
    ...
    OAOStTrans( ey, StConstrTarget.init(5, 4) );
...
#pragma omp target teams distribute parallel for private(i, j) collapse(2)
    ...
    OAOStTrans( ex, StConstrTarget.init(5, 4) );
...
#pragma omp target teams distribute parallel for private(i, j) collapse(2)
    ...
    OAOStTrans( hz, StConstrTarget.init(5, 4) );
...
void runFdtd_OMP(DATA_TYPE *_fict_, DATA_TYPE *ex, DATA_TYPE *ey, DATA_TYPE *hz) {
    ...
    OAOStTrans( _fict_, StConstrTarget.init(7, 7) );
    OAOStTrans( ex, StConstrTarget.init(7, 7) );
    OAOStTrans( ey, StConstrTarget.init(7, 7) );
