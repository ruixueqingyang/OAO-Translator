...
void kernel_1(DATA_TYPE *_fict_, DATA_TYPE *ey, int t) {
  ...
  char RST_AI1 = 0;
  RST_AI1 |= !(((void*) (_fict_ + 0) > (void*) (ey + 2047))
  || ((void*) (ey + 0) > (void*) (_fict_ + 499)));
  #pragma omp target data map(to: _fict_[0:500]) map(tofrom: ey[0:2048]) if(!RST_AI1)
  {
...
void kernel_2(DATA_TYPE *ey, DATA_TYPE *hz) {
  int i, j;
  char RST_AI1 = 0;
  RST_AI1 |= !(((void*) (ey + 0) > (void*) (hz + 4194303))
  || ((void*) (hz + 0) > (void*) (ey + 4194303)));
  #pragma omp target data map(to: hz[0:4194304]) map(tofrom: ey[0:4194304]) if(!RST_AI1)
  {
...
void kernel_3(DATA_TYPE *ex, DATA_TYPE *hz) {
  ...
  char RST_AI1 = 0;
  RST_AI1 |= !(((void*) (ex + 0) > (void*) (hz + 4194303))
  || ((void*) (hz + 0) > (void*) (ex + 4196350)));
  #pragma omp target data map(to: hz[0:4194304]) map(tofrom: ex[0:4196351]) if(!RST_AI1)
  {
  #pragma omp target parallel for private(i, j) collapse(2) if(!RST_AI1)
  for (i = 0; i < NX; i++) {
    for (j = 1; j < NY; j++) {
...
void kernel_4(DATA_TYPE *ex, DATA_TYPE *ey, DATA_TYPE *hz) {
  ...
  char RST_AI1 = 0;
  RST_AI1 |= !(((void*) (ex + 0) > (void*) (ey + 4196351))
  || ((void*) (ey + 0) > (void*) (ex + 4196351)));
  RST_AI1 |= !(((void*) (ex + 0) > (void*) (hz + 4194303))
  || ((void*) (hz + 0) > (void*) (ex + 4196351)));
  RST_AI1 |= !(((void*) (ey + 0) > (void*) (hz + 4194303))
  || ((void*) (hz + 0) > (void*) (ey + 4196351)));
  #pragma omp target data map(to: ex[0:4196352],ey[0:4196352]) map(tofrom: hz[0:4194304]) if(!RST_AI1)
  {
  #pragma omp target parallel for private(i, j) collapse(2) if(!RST_AI1)
  for (i = 0; i < NX; i++) {
    for (j = 0; j < NY; j++) {
