...
void GPU__conv2D(DATA_TYPE *A, DATA_TYPE *B) {
  ...
  char RST_AI1 = 0;
  RST_AI1 |= !(((void*) (A + 0) > (void*) (B + 603979775))
  || ((void*) (B + 0) > (void*) (A + 603979775)));
  #pragma omp target data map(to: A[0:603979776]) map(tofrom: B[0:603979776]) if(!RST_AI1)
  {
...
inline void update(DATA_TYPE *B_OMP) { DATA_TYPE bb = B_OMP[0]; }
...
int main() {
  ...
  if(threshold > NI*NJ*sizeof(DATA_TYPE)){
      ...
      cudaMallocHost((void**)&B_OMP, NI*NJ*sizeof(DATA_TYPE));
  }
