...
int main()
{
  ...
  OAODataTrans( x1_outputFromGpu, StConstrTarget.init(7, 3) );
  OAODataTrans( x2_outputFromGpu, StConstrTarget.init(7, 3) );
  OAODataTrans( y_1, StConstrTarget.init(7, 3) );
  OAODataTrans( y_2, StConstrTarget.init(7, 3) );
