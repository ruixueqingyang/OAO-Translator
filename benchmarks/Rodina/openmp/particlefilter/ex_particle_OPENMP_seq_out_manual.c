...
#pragma omp target data map(tofrom : Nparticles, weights[:Nparticles])
    {
...
#pragma omp target data map(tofrom : Nparticles, arrayX[:Nparticles], arrayY[:Nparticles])
    {
...
#pragma omp target data map(tofrom : Nparticles, seed[:Nparticles], arrayX[:Nparticles], arrayY[:Nparticles])
        {
#pragma omp target teams distribute parallel for shared(arrayX, arrayY, Nparticles, seed) private(x)
        ...
        int len1 = countOnes * 2;
        int len2 = countOnes * Nparticles;
#pragma omp target data map(tofrom : objxy[:len1], ind[:len2], likelihood[:Nparticles], arrayX[:Nparticles], arrayY[:Nparticles], I[:max_size])
        {
#pragma omp target teams distribute parallel for private(x, y, indX, indY)
            for (x = 0; x < Nparticles; x++) {
...
#pragma omp target data map(tofrom : Nparticles, weights[:Nparticles], likelihood[:Nparticles])
        {
#pragma omp target teams distribute parallel for shared(Nparticles, weights, likelihood) private(x)
        ...
        double sumWeights = 0;
#pragma omp target data map(tofrom : weights[:Nparticles])
        {
...
#pragma omp target data map(tofrom : Nparticles, arrayX[:Nparticles], arrayY[:Nparticles], weights[:Nparticles])
        {
...
#pragma omp target data map(tofrom : Nparticles, u[:Nparticles])
        {
#pragma omp target teams distribute parallel for shared(u, u1, Nparticles) private(x)
        ...
        int j, i;
#pragma omp target data map(tofrom : arrayX[:Nparticles], arrayY[:Nparticles], CDF[:Nparticles], xj[:Nparticles], yj[:Nparticles], u[:Nparticles])
        {
...
#pragma omp target data map(tofrom : Nparticles, arrayX[:Nparticles], arrayY[:Nparticles], weights[:Nparticles], xj[:Nparticles], yj[:Nparticles])
        {
#pragma omp target teams distribute parallel for shared(weights, Nparticles) private(x)
            for (x = 0; x < Nparticles; x++) {
