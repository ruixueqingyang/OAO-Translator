...
//
#pragma omp parallel for default(none) private(chunk_idx) shared(size, chunks_per_inter, chunks_in_inter_row, offset, a)
...
#pragma omp parallel for schedule(auto) default(none) private(chunk_idx) shared(size, chunks_per_inter, chunks_in_inter_row, offset, a)
