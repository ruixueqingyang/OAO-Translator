...
void BFSGraph( int argc, char** argv) 
{
    ...
    OAOStTrans( h_graph_nodes, StConstrTarget.init(3, 2) );
    OAOStTrans( h_graph_mask, StConstrTarget.init(3, 2) );
    OAOStTrans( h_updating_graph_mask, StConstrTarget.init(3, 2) );
    OAOStTrans( h_graph_visited, StConstrTarget.init(3, 2) );
    ...
    OAOStTrans( h_graph_edges, StConstrTarget.init(3, 2) );
    ...
    for(int i=0;i<no_of_nodes;i++)
        h_cost[i]=-1;
        OAOStTrans( h_cost, StConstrTarget.init(3, 2) );
...
#pragma omp target data map(to: no_of_nodes, h_graph_mask[0:no_of_nodes], h_graph_nodes[0:no_of_nodes], h_graph_edges[0:edge_list_size], h_graph_visited[0:no_of_nodes], h_updating_graph_mask[0:no_of_nodes]) map(h_cost[0:no_of_nodes])
    ...
    OAODataTrans( h_cost, StConstrTarget.init(7, 2) );
    for(int i=0;i<no_of_nodes;i++)
